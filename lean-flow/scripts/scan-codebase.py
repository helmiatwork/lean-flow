...
def scan_directory(root: Path, encoding: tiktoken.Encoding, max_file_tokens: int = 50000) -> dict:
    root = root.resolve()
...
def main():
    ...
    parser.add_argument("--format", choices=["json", "tree", "compact"], default="json", help="Output format (default: json)")
    parser.add_argument("--max-tokens", type=int, default=50000, help="Skip files with more than this many tokens (default: 50000)")
    parser.add_argument("--encoding", default="cl100k_base", help="Tiktoken encoding to use (default: cl100k_base)")
