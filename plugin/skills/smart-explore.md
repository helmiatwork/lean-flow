...
<!--
Adapted from claude-mem (https://github.com/thedotmack/claude-mem)
Original license: Apache-2.0

Requires tree-sitter MCP server providing smart_search / smart_outline / smart_unfold tools.
Install separately — not bundled with lean-flow.
-->
